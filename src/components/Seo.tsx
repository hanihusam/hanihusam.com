...
export default function Seo(props: SeoProps) {
  ...
  return (
    <Head>
      ...
      <meta content="@th_clarence" name="twitter:site" />
      ...
      {meta.date && (
        <>
          ...
          <meta content={meta.date} name="publish_date" property="og:publish_date" />
          <meta content="Theodorus Clarence" name="author" property="article:author" />
        </>
      )}
